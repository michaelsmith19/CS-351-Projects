...
/**
 * This is a basic PQueue.  There is one special case
 * any class using an instance of this class must add
 * @author michaelsmith
 *
 */
...
public class PQueueBasic implements PQueue{
	...
	public PQAble[] getHeapArray() {
		return heapArray;
	}

	public void setHeapArray(PQAble[] heapArray) {
