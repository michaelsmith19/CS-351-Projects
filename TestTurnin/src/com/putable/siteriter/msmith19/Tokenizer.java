...
public class Tokenizer {
	...
	/**
	 *  This method takes the reader and its SLiteral token and continues 
	 *  to read in the characters until it finishes with a closing '. It will
	 *  drop both the opening and closing single quote. It will throw an exception
	 *  if it reaches EOI without finishing the literal.
	 * @param reader the input reader
	 * @param token token who's value is being read in.
	 * @throws IOException
	 */
	...
	/**
	 *  This method takes the reader and its DLiteral token and continues 
	 *  to read in the characters until it finishes with a closing \". It will
	 *  drop both the opening and closing double quote. It will throw an exception
	 *  if it reaches EOI without finishing the literal.
	 * @param reader the input reader
	 * @param token token who's value is being read in.
	 * @throws IOException
	...
	/**
	 * This method constructs a name. It takes in a reader and the character that is it's
	 * start character.  It will return the character that ends the name. If it does not 
	 * finish the name before EOI it will throw an exception.
	 * @param reader the input reader
	 * @param token the name token who's value is being read.
	 * @param character the character that started the name.
	 * @return the character that ended the name.
	 * @throws IOException
	 */
	
	private int makeName (Reader reader, Token token, int character) throws IOException {
		int ch = character;
