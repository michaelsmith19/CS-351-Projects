...
/**
 * The PairPanickGrid is the Grid that contains the PairPanick game and
 * its game logic.
 * 
...
public class PairPanickGrid extends Grid{
	...
	/* (non-Javadoc)
	 * @see com.putable.tilenet.blueprints.Grid#placeParts()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.putable.tilenet.blueprints.Grid#addDefaultTokens()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.putable.tilenet.blueprints.Grid#giveManager(com.putable.tilenet.AgentManager.AgentManager)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.putable.tilenet.blueprints.Grid#removeAgent(com.putable.tilenet.matrixelement.Agent)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.putable.tilenet.blueprints.Grid#addAgent(com.putable.tilenet.matrixelement.Agent)
	 */
	@Override
		            ...
		            public void run() {
		            	if (!(lastTwoGuesses.isEmpty())){
		            		for(int i = 0; i < lastTwoGuesses.size(); i++){
		            			...
		            			for (Agent ag : agentsConnected)
		            				manager.getConnection(ag).sendMessage((lastTwoGuesses.get(i)));
		            		}
		            	}
						lastTwoGuesses.clear();
		            }
	...
	//This is where most of the Game Logic is located
