...
public class ServerModelTest {
	...
	@Test
	public void testMaxConnection() throws UnknownHostException, IOException, InterruptedException, ExecutionException {
	...
	public void testPortBind() throws InterruptedException, ExecutionException  {
		...
		Server redundantserver = new Server(AllTests.TEST_PORT, AllTests.MAX_CONNECTIONS);
